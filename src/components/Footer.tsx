...
const Footer = () => {
  return (
    <footer className="bg-eldo-dark text-white pt-16 pb-8">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          <div>
            <div className="flex items-center mb-6">
              <span className="text-white font-bold text-2xl">eldo</span>
              <span className="text-eldo-purple font-light text-lg ml-1">copilot</span>
            </div>
            <p className="text-white/60 mb-6">
              Simplifying the Canadian immigration journey with AI-powered tools and guidance.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-white/60 hover:text-white transition-colors">Express Entry Guide</a></li>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center">
          <div className="text-white/60 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Eldo Copilot. All rights reserved.
          </div>
